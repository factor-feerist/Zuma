...
class Level:
    def __init__(self, name, route: Route, skull_pos: QVector2D, frog_pos: QVector2D, balls_count, time_limit=None):
        self.name = name
        self.route = route
...
def make_first_level():
    ...
    return Level(name='level 1', route=route, skull_pos=skull_position,
                 frog_pos=frog_position, balls_count=balls_count, time_limit=time_limit)
...
def make_second_level():
    ...
    balls_count = 5
    time_limit = None
    return Level(name='level 2', route=route, skull_pos=skull_position,
                 frog_pos=frog_position, balls_count=balls_count, time_limit=time_limit)
